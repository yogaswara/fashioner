				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="leftbox">
						<div class="description">
							<h4 class="form-title">Please enter your new password</h4>
							<form class="contact-form" id="forget" action="{{url('member/recovery/'.$id.'/'.$code)}}" method="post">
								<fieldset>
									<div class="form-group">
										<input type="password" name="password" placeholder="New Password" class="form-control theme-style" value="{{Input::old('password')}}" required autofocus>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="col-lg-6 col-xs-12">
											<button type="submit" class="theme-btn" id="login">Save</button>
										</div>
									</div>
								</fieldset>
							</form>
